  ...
  return (
    <div className="bg-accent-1 md:p-10 p-5">
      <h2 className="sub-title">
        {isSignedin ? "Sign In Customer" : "Register Customer"}
      </h2>
      <p className="md:text-sm text-xs font-light py-5">
          ...
          <div className="flex items-center gap-5">
            <div>
              <Button
                type="submit"
                variant={"primary"}
                text={isSignedin ? "Sign In" : "Register"}
                color={"default"}
              />
            </div>
            {isSignedin && (
              <Link
                ...
                className="md:text-sm text-[11px] text-primary-custom"
              >
