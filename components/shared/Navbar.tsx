  ...
  return (
    <div className="navbar-container">
        ...
        <div className="md:static absolute top-27 right-0 left-0 md:shadow-none md:bg-transparent">
          ...
          >
            {menuItems.map((item, i) => (
              <Link href={item.link} key={i} className="text-sm font-semibold">
                {item.name}
              </Link>
            ))}
          </div>
      ...
      <div className="flex items-center gap-5">
        ...
        <button className="md:w-9 md:h-9 w-[34px] h-[34px] flex items-center justify-center border-2 md:border-black border-white rounded-full">
